        ...
        <div className="container about-pizza">
		    ...
		    <div className="row">
			    <div className="col-md-6">
				    <img src="images/daamn-pizza.jpg" className="img-thumbnail" alt="pizza" />
                </div>
			    <div className="col-md-6 section-text">
				    ...
				    <p>Italy has many variations of pizza. The Neapolitan pizza, or Naples-style pizza, is made specifically with buffalo mozzarella (produced from the milk of Italian Mediterranean buffalo) or fior di latte (mozzarella produced from the milk of prized Agerolese cows) and with San Marzano tomatoes or pomodorino vesuviano (a variety of grape tomato grown in Naples).</p>
			    </div>
		    </div>
	    </div>
    )
